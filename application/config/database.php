...
$db['local_db'] = array(
    'dsn' => '',
    'hostname' => 'localhost',
    'username' => 'cmoonphpteam2022',
    'password' => 'cmoon@GTDjd',
...
define('BCC_EMAIL', $rw->contact_email);
define('CONTACT_EMAIL', $rw->contact_email);
define('CONTACT_NUMBER', $rw->contact_number);
