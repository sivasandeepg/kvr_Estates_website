            ...
            <div class="col-lg-10">
                <div class="about-box6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="item-heading-center">
                        <h2 class="section-title"><?= $privacy_policy->sub_heading ?></h2>
                        <span class="section-subtitle"><?= $privacy_policy->heading ?></span>

                        <div class="bg-title-wrap" style="display: block;">
<!--                            <span class="background-title solid">Privacy Policy</span>-->
                        </div>
                    </div>
