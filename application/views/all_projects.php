                                ...
                                <div class="nice-select select single-select mr-0" tabindex="0">
                                    ...
                                    <ul class="list">
                                        ...
                                        foreach ($cities as $city) {
                                            ...
                                            ?>
                                            <li class="option">
                                                <input id="a-<?= $i ?>" onclick="check()" class="checkbox-custom" value="<?= $city->id ?>" type="checkbox" name="city[]" <?= $_GET['city'][$i] == $cities['id'][$i] ? checked : '' ?>>
                    ...
                    <?php foreach ($projects as $row) { ?>
                        <div class="col-lg-4 col-md-6">
                            <div class="property-box2 property-box8 wow animated fadeInUp" data-wow-delay=".6s">
                                <div class="item-img">
                                    <a href="<?= base_url() ?>project_view/<?= $row->slug ?>"><img src=" <?= base_url() ?>uploads/<?= $row->image ?>" alt="blog" width="510" height="340"></a>
                                ...
                                <div class="item-category10"><a href="<?= base_url() ?>project_view/<?= $row->slug ?>"><?= $property_type ?></a></div>
