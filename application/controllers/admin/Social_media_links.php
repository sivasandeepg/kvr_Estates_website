...
class Social_media_links extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "Social Media Settings";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "social_media";
        ...
        $this->data['hide_columns_in_list_view'] = array("updated_at", "status");

        $this->data['hide_columns_in_edit_view'] = array("updated_at", 'unique_code', 'status');
        ...
        $this->data["exclude_ck_editor_fields"] = array("keywords", "description");
    ...
    function index() {
        redirect("admin/social_media_links/edit/1");
