...
class Property_type extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "Property Type";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "property_type";
        ...
        $this->data['hide_columns_in_list_view'] = array("updated_at", 'password', 'salt', 'password',
            ...
            'activation_key',
            'token', 'email_verified', "id_no");

        $this->data['hide_columns_in_edit_view'] = array("updated_at", "id_no");
        $this->data['hide_columns_in_add_view'] = array("id_no");
