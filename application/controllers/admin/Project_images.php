...
class Project_images extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "Project Images";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "project_images";
            ...
            if (isset($_POST['submit'])) {
                ...
                if ($_POST['submit'] == "insert") {
                    ...
                    if ($obj->posted_values_dynamic_update()) {
                        //any extra code such as email, sms functionality code
                        redirect($this->data['current_page_link'] . "?msg=update&project_id=" . $_REQUEST['project_id']);
                    }
                }
            }
        }
...
//        project_images
        ...
        if (!empty($this->input->get_post('project_id'))) {
            $this->db->where('project_id', $this->input->get_post('project_id'));
        }
    ...
    function delete($item_primary_key) {
        ...
        $prjt_id = $this->db->get('project_images')->row()->project_id;
