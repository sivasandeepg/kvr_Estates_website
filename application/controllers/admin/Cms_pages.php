...
class Cms_pages extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "CMS Pages";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "cms_pages";
        ...
        $this->data['column_name_display_as'] = array('city_name' => 'City Name',
            'role_id' => 'Role',
            'time' => 'Date and Time');
        $this->data['hide_columns_in_list_view'] = array('id',
            'long_description', 'regular_price', 'shot_description', 'name_ar',
            'long_description_ar', 'regular_price', 'shot_description_ar',
            'brands_id', 'special_product', 'best_selling', 'purchase_price',
            'product_type', 'weight', 'length', 'height', 'width', 'in_stock', 'UPC',
            'cod_enable', 'seo_title', 'seo_description', 'seo_keywords',
            'seo_title_ar', 'seo_description_ar', 'seo_keywords_ar');

        $this->data['hide_columns_in_edit_view'] = array("updated_at", "link");
        $this->data['hide_columns_in_add_view'] = array("");
        $this->data['image_fields'] = array('image', 'image2', 'image3');
        ...
        $this->data['readonly_fields'] = array("link");
