...
class Blog extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "Blog";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "";
        ...
        $this->data['hide_columns_in_list_view'] = array("updated_at", 'password', 'salt', 'password',
            ...
            'activation_key',
            'token', 'email_verified', "seo_title");

        $this->data['hide_columns_in_edit_view'] = array("updated_at", "seo_title");
        $this->data['hide_columns_in_add_view'] = array("seo_title");
