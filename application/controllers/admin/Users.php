...
class Users extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "User";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "registered_users";
        ...
        $this->data['column_name_display_as'] = array('city_name' => 'City Name',
            'role_id' => 'Role',
            'time' => 'Date and Time');
        $this->data['hide_columns_in_list_view'] = array("updated_at", "access_token");
        $this->data['hide_columns_in_edit_view'] = array("updated_at", "access_token");
        $this->data['hide_columns_in_add_view'] = array("status", "role_id", "access_token", "updated_at");
        ...
        $this->data['unique_fileds'] = array('username');
        ...
        $this->data["generate_random_key_fields"] = array('access_token');
            ...
            if (isset($_POST['submit'])) {
                if ($_POST['submit'] == "insert") {
                    ...
                    if ($obj->posted_values_dynamic_save()) {
                        ...
                        $mobile = $_POST['mobile'];
                        $email = $_POST['email'];
                        $playstore_url = $this->db->get_where('site_settings')->row()->playstore_url;
                        $msg = "Dear $name, your registration successful for " . SITE_TITLE . "
Username : $mobile
Download mobile app $playstore_url
";
                        send_message($msg, $mobile);
