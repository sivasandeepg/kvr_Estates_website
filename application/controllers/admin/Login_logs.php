...
class Login_logs extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "Login Logs";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "login_logs";
        ...
        $this->data['unset_all_actions'] = true;
        ...
        $this->data['column_name_display_as'] = array(
            'user_id' => 'User', 'time' => 'Date and Time', 'created_at' => 'Logged In At');
    ...
    function index() {
        $this->data["list_items"] = $this->db->query("SELECT * FROM " . $this->data['primary_table_name'] . " ORDER BY id DESC")->result();
