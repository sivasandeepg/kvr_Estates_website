...
class Sub_menu extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "Sub Menu";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "admin_dashboard_sub_menu";
        $this->data['current_page_link'] = base_url() . "admin/sub_menu";
        ...
        $this->data['hide_columns_in_add_view'] = array('updated_at',
            'password',
            'salt',
            'forgot_password_verfication_code',
            'activation_key',
        ...
        $this->data['hide_columns_in_edit_view'] = array("updated_at", 'password', 'salt');
        $this->data['hide_columns_in_add_view'] = array("forgot_password_verfication_code",
            "activation_key",
        ...
        $this->data['relation_fields'] = array(
            'main_menu_id' => array('table_name' => 'admin_dashboard_main_menu', 'display_column_name' => 'menu_name', "condition" => array(""))
        );
