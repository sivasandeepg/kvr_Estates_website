...
class Kvr_profile extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "Kvr Profile";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "home_other";
        ...
        $this->data['image_fields'] = array('image', 'about_image_one', 'about_image_two', 'about_image_three', 'about_image_four', 'image_testimonials', 'property_image');
