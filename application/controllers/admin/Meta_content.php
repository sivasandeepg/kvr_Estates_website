...
class Meta_content extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "Meta content";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "meta_content";
        ...
        $this->data['image_fields'] = array('image', 'seo_image');
        ...
        $this->data['readonly_fields'] = array('page');
