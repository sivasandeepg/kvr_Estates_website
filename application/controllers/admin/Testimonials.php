...
class Testimonials extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "Testimonials";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "testimonials";
        ...
        $this->data['column_name_display_as'] = array('role_id' => 'User Role', 'star' => "Star Rating", 'time' => 'Date and Time');
