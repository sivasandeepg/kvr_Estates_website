...
class Blog_images extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "Blog Images";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "blog_images";
        ...
        $this->data['hide_columns_in_add_view'] = array("status", "status");
