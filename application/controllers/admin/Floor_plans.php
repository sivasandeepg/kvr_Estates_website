...
class Floor_plans extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "Floor plans";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "floor_plans";
        ...
        $this->data['relation_fields'] = array(
            'project_id' => array('table_name' => 'projects', 'display_column_name' => 'title', "condition" => array(""))
        );
            ...
            if (isset($_POST['submit'])) {
                ...
                if ($_POST['submit'] == "insert") {
                    ...
                    if ($obj->posted_values_dynamic_save()) {
                        ...
                        redirect($this->data['current_page_link'] . "?msg=add&project_id=" . $_REQUEST['project_id']);
                    ...
                    if ($obj->posted_values_dynamic_update()) {
                        ...
                        redirect($this->data['current_page_link'] . "?msg=update&project_id=" . $_POST['project_id']);
    ...
    function index() {
        ...
        $projects = $this->db->get('floor_plans')->result();

        $this->data["list_items"] = $projects;

        // $this->admin_view("list_view");
        $this->admin_view("list_view_floor_plans");
    }
    ...
    function edit($item_primary_key) {
        ...
        $this->admin_view("edit_view_1");
    }

    function delete($item_primary_key) {
        $this->db->where("id", $item_primary_key);
        $prjt_id = $this->db->get('floor_plans')->row()->project_id;
        ...
        if ($this->data["action_buttons"]['delete_action'] == true) {
            ...
            redirect($this->data['current_page_link'] . "?msg=delete&project_id=" . $prjt_id);
        } else {
