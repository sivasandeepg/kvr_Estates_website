...
class City extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "City";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "city";
        ...
        $this->data['column_name_display_as'] = array('name' => 'City Name',
            'role_id' => 'Role',
            'time' => 'Date and Time');
        $this->data['hide_columns_in_list_view'] = array("updated_at", 'password', 'salt', 'password',
            ...
            'activation_key',
            'token', 'email_verified', "slug", "properties");

        $this->data['hide_columns_in_edit_view'] = array("updated_at", "slug", "properties");
        $this->data['hide_columns_in_add_view'] = array("slug", "properties");
        ...
        $this->data['relation_fields'] = array(
            'state_id' => array('table_name' => 'state', 'display_column_name' => 'name', "condition" => array(""))
        );
        $this->data['multiple_selection_of_options'] = array("role_ids");

        $this->data['column_name_display_as'] = array('role_id' => 'User Role', 'time' => 'Date and Time', 'name' => 'City Name');

        $this->data['unique_fileds'] = array('name');
        ...
        if (!empty($_POST)) {
            ...
            if (isset($_POST['submit'])) {
                ...
                if ($_POST['submit'] == "insert") {
                    ...
                    $_POST['slug'] = make_seo_name($_POST['name']);
    ...
    function index() {
        ...
        $this->data["list_items"] = $this->db->get()->result();
