...
class Blog_categories extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "Blog categories";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "blog_categories";
        ...
        $this->data['hide_columns_in_add_view'] = array('slug');
        ...
        $this->data['unique_fileds'] = array("category_name");
        ...
        if (!empty($_POST)) {
            ...
            if (isset($_POST['submit'])) {
                ...
                if ($_POST['submit'] == "insert") {
                    ...
                    $_POST['slug'] = make_seo_name($_POST['category_name']);
