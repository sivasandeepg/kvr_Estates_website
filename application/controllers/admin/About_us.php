...
class About_us extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "About us";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "about_us";
        ...
        $this->data['hide_columns_in_list_view'] = array("updated_at", 'password', 'salt', 'password',
            ...
            'activation_key',
            'token', 'email_verified', 'name', "status");

        $this->data['hide_columns_in_edit_view'] = array("updated_at", "name", "status");
        $this->data['hide_columns_in_add_view'] = array("status", "name");
        $this->data['image_fields'] = array('image', 'about_image_one', 'about_image_two', 'about_image_three', 'about_image_four');
            ...
            if (isset($_POST['submit'])) {
                ...
                if ($_POST['submit'] == "insert") {
                    ...
                    if ($obj->posted_values_dynamic_update()) {
                        //any extra code such as email, sms functionality code
                        redirect($this->data['current_page_link'] . "/edit/2");
                    }
                }
            }
        }
