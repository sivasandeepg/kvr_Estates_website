...
class State extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "State";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "state";
        ...
        $this->data['column_name_display_as'] = array('name' => 'State Name',
            'role_id' => 'Role',
            'time' => 'Date and Time');
        ...
        $this->data['relation_fields'] = array(
            'city_id' => array('table_name' => 'city', 'display_column_name' => 'city_name', "condition" => array(""))
        );
