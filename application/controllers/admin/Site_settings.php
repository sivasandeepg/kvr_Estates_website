...
class Site_settings extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['add_subject'] = "Website Settings";
        $this->data['subject'] = plural($this->data['add_subject']);
        $this->data['primary_table_name'] = "site_settings";
        ...
        $this->data['hide_columns_in_list_view'] = array("address", "about_site", "google_maps", "created_at", "status", "seo_title");

        $this->data['hide_columns_in_edit_view'] = array("updated_at", 'unique_code', 'status', "seo_title");
        $this->data['hide_columns_in_add_view'] = array("unique_code", "status", "seo_title");
        $this->data['image_fields'] = array('image', "logo", "favicon", "fav_icon", "footer_bg_image");
        ...
        $this->data["exclude_ck_editor_fields"] = array("keywords", "description", "playstore_url", "contact_address", "seo_title", "seo_keywords", "seo_description", "seo_author", "working_hours", "google_maps");
